                        ...
                        <div class="col-lg-9 col-md-8 col-6">
                            <div class="header-bottom-right">
                                <div class="main-menu">
                                    <nav>
                                        <ul>
                                            <li class="top-hover"><a href="index.html">家</a>
                                                <ul class="submenu">
                ...
                <div class="single-slider ptb-240 bg-img" style="background-image:url(assets/img/slider/slider-1.jpg);">
                    <div class="container">
                        <div class="slider-content slider-animated-1">
                            <h1 class="animated">想保持 <span class="theme-color">健康</span></h1>
                            <h1 class="animated">喝抹茶。</h1>
                            <p>抹不掉的不可能抹去的;不能消除的 抹不掉的擦不掉的 抹不掉的痕迹，这是劳动和悲伤。</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="product-content text-left">
							<div class="product-hover-style">
								<div class="product-title">
									<h4>
										<a href="mocha/detail">自然密茶</a>
									</h4>
								</div>
								<div class="cart-hover">
									<h4><a href="mocha/detail">+ 加入购物车</a></h4>
								</div>
							</div>
									...
									<div class="product-content text-left">
										<div class="product-hover-style">
											<div class="product-title">
													...
													<h4><a href="mocha/detail">社会冰茶</a>
														</h4>
												
											</div>
											<div class="cart-hover">
												<h4><a href="mocha/detail">加购物车</a></h4>
											</div>
										</div>
										<div class="product-price-wrapper">
											<span>￥100.00 -</span>
					...
					<div class="col-lg-4 col-md-6">
						<div class="blog-single mb-30">
							...
							<div class="blog-content pt-25">
								<span class="blog-date">9月14号</span>
								<h3><a href="#">Lorem 存有坐火焰合作。</a></h3>
